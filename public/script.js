...
// Display dictionary
dictionaryNav.addEventListener(
	"click",
	function() {
        //shows dictionary
...
form.addEventListener("submit", function(event) {
    ...
    if (task) {
        addTask(task, dueDate, estimatedTime, priorityRating, completionStatus, false);
    }
})
...
/* Function to toggle startstop button */
function startStop() { 
...
/* Function adds 0 when value is <10 */
...
resetPom.addEventListener("click", 
    function() {
        resetTime();
        timerPom.textContent = "25:00";
        //toggle startstop buttons display
...
synonyms = wrapper.querySelector(".synonyms .syn-list"),
